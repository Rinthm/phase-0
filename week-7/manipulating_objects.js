...
What tests did you have trouble passing? What did you do to make it pass? Why did that work?
  ...
  I had trouble with assigning terah's spouse property with the value of adam. I didn't know
  'spouse' had to be in quotes. Once I figured this out, the rest was pretty easy. It had to
  be in quotes because without them, JavaScript tried to read it as an improperly defined variable.

How difficult was it to add and delete properties outside of the object itself?

  It was not difficult at all; once I relearned the syntax, it was very intuitive and 
  straight-forward.

What did you learn about manipulating objects in this challenge?

  I learned that property names need to be in quotes. I also learned that you can add/delete 
  in objects much like you can in Ruby arrays/hashes (by using brackets and picking out which
  properties/values you want to add/delete).
*/
